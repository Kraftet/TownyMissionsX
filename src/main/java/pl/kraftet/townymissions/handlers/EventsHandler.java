...
import pl.kraftet.townymissions.events.gui.TownMissionGUIEvents;
import pl.kraftet.townymissions.events.town.NewNationEvents;
...
public class EventsHandler {
    ...
    public void handler() {
        ...
        getServer().getPluginManager().registerEvents(new TownMissionGUIEvents(plugin), plugin);
        getServer().getPluginManager().registerEvents(new NewTownEvents(plugin), plugin);
        getServer().getPluginManager().registerEvents(new NewNationEvents(plugin), plugin);
