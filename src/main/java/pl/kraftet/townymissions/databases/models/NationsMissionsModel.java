...
public class NationsMissionsModel {
    ...
    public NationsMissionsModel(String nation, long current_ammount, long required_ammount, String mission_type, String uuid, long stored, int completed) {
        this.nation = nation;
