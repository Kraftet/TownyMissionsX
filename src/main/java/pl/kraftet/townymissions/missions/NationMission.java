...
public class NationMission {
    private static TownyMissions plugin;
    private static Economy econ;
    public NationMission(TownyMissions plugin) {
        NationMission.plugin = plugin;
    }
    public static void generate(Nation nation) throws SQLException {
        ...
        for (Resident resident : residents) {
            ...
            String sql = "INSERT INTO towny_missions(nation, current_amount, required_amount, mission_type, uuid, stored) " +
                    "VALUES ('" + nation.toString() + "', 0, " + required_amount + ", '" + mission_type + "', '" + uuid.toString() + "', 0)";
